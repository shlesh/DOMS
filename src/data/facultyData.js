const facultyData = [
  {
    ...
    bio: "Dr. Singh possesses BBA, MBA, Ph.D., PGDCA, PGDCMD Degrees to her credit. Currently, her area of Work & Research is Marketing; Services & Digital Marketing., Entrepreneurship & Emotional Intelligence along with teaching Professional Communication & Business Process Modelling to Engineering Graduate students at IIIT Allahabad. She has published research papers in more than 30+ International & National Journals and Presented Papers at Pennsylvania State University, Clarion University of Pennsylvania, Attended Communication Leadership Workshop at Harvard School of Continuing Education, USA. She has Conducted/Organized SIX Training Programs, Seminars/Workshops & Conferences sponsored by AICTE ATAL, DST. Successfully completed Three Projects Sponsored by IIIT-Allahabad, Ministry of Chemical & Fertilizers, and Department of Science & Technology, Govt of India. Mentorship of Master Project students at IIIT-Allahabad and Guidance of regular Ph.D. Candidates in both regular & Working Professionals Scheme ongoing at IIIT Allahabad. Also has a rich Teaching Expertise of 15 Years and is currently working at the Institute of National Importance (IIIT Allahabad), Government of INDIA Since Sept. 2012. Visiting Faculty to Regional Training Institute, Allahabad (Senior INDIAN ADMINISTRATIVE SERVICES OFFICERS & Audit officers) & External Supervisor at IIIT-Una (HP), AIMA-AMU, New Delhi, Sanskriti University, Mathura, Uttar Pradesh",
    researchInterests: ["Marketing", " Entrepreneurship, & Investment Management." ],
    address: [
...
//   export { facultyData, findFacultyById };
